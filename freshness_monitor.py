...
MONITORED = [
    ...
    ("wage_negotiation.json", 200), # DART 사업보고서 기반 — 연 1회 갱신
    ...
    ("fear_greed.json", 30), ("trend_signal.json", 36), ("guru_13f.json", 36),
    ("kospi_open_log.json", 30),   # 시초가 예측 워크포워드 채점 (해외시장 워크플로에 동봉, 매시간)
    ("dart_financials.json", 40),
