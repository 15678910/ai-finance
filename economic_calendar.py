...
CURATED_EVENTS = [
    ...
    # ── SK하이닉스 미국 ADR 상장 (진행 중 catalyst) ───────────────
    {
        ...
        "impact": "HIGH",
        "region": "🇰🇷🇺🇸",
        "detail": ("NYSE ADR 상장 추진 — SEC 비공개 신청(3월) → 승인 임박(6/22 주), 빠르면 7~8월 데뷔. "
                   "공모 $8~26B(미확정), HBM·AI 메모리 증설 자금. 장외 티커 HXSCL."),
        "tags": ["SK하이닉스", "ADR", "반도체", "HBM", "상장"],
        "impact_analysis": (
            "🟢 재평가: NYSE 유동성·패시브 편입으로 코리아 디스카운트 해소 → 마이크론·엔비디아 대비 멀티플 상향 기대. "
            "ADR이 美 장중 거래 시 한국↔미국 디커플링 완화 → 개장전 예측 정확도 개선 여지. "
            "🔴 신주 희석(자사주 소진→발행 불가피)·고점권 자본조달·'뉴스에 팔자' 되돌림 위험. "
            "결국 메모리(DRAM·HBM) 가격 정점 통과가 진짜 분기점."
        ),
    },
