...
def main():
    ...
    out = {
        ...
        "recent_shock": {
            "date": "2026-06-23",
            "title": "KOSPI -10% 폭락 (서킷브레이커 2회)",
            "text": ("SK -12.5%·삼성 -12.3%·KOSPI -10%(8,204). 스파크=글로벌 AI/반도체 밸류에이션 조정 — "
                     "나스닥선물·닛케이225 동반 급락(키오시아 -15%)이라 한국만의 사건이 아님. "
                     "한국이 2.5배(나스닥 -4% vs KOSPI -10%) 더 빠진 건 증폭기 때문: 반도체 극단 쏠림"
                     "(SK +348%·6/22 시총 1위)+ADR 유상증자 오버행+레버리지 롱 청산+규제 우려. "
                     "레버리지·서킷브레이커는 증폭기지 근본원인 아님. sk_cycle '고점권 경계' 경고가 현실화."),
        },
