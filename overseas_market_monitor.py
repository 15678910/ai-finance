...
#
# 야간선물(코스피200 야간물)을 쓰지 않는 이유: (2026-08-09 재확인)
#   ① 야간 세션 시세를 받을 경로가 없다. 확인한 것:
#        · pykrx 선물 상품군 28개에 야간·EUREX·CME 연계 상품이 없음
#        · get_future_ohlcv_by_ticker 는 동작하지만(예전 주석의 NotImplementedError 는 낡음)
#          코스피200 선물 전 종목이 '(주간)' 으로만 조회되고 alternative=True 도 결과 동일
