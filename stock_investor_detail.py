...
PREDEFINED_EVENTS = [
    {
        "date": "2026-05-23",
        "label": "스타벅스 5.23 추모기간 홍보 논란",
        "description": "스타벅스코리아의 5.23 추모일 부적절한 마케팅 → 보이콧 + 사회적 비판",
        "affected_tickers": ["139480", "004170"],   # 이마트, 신세계
        "comparison_tickers": ["023530", "008770", "069960"],   # 롯데쇼핑, 호텔신라, 현대백화점
    },
]
